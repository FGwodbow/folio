...
var electronAPI = {
  ...
  kernel: {
    ...
    listManifests: () => import_electron.ipcRenderer.invoke("manifests:list"),
    getManifest: (runId) => import_electron.ipcRenderer.invoke("manifests:get", runId),
    compareManifests: (leftRunId, rightRunId) => import_electron.ipcRenderer.invoke("manifests:compare", leftRunId, rightRunId),
